...
ans_time = time.hour.to_s + "時" + time.min.to_s + "分" +time.sec.to_s + "秒"   #Rubyググれば理解できるはず
...
EOS
 ...
 content = f.read().gsub(/# daytime_start.*# daytime_end/m, FST_TEXT.toutf8)    #サブFSTを上の内容に書き換えています
